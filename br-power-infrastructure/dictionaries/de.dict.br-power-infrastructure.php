...
Dict::Add('DE DE', 'German', 'Deutsch', array(
    ...
    'PowerDistributionBoard:boardinfo' => 'Verteilungsdaten',
    'Class:PowerDistributionBoard' => 'Stromverteilung',
    'Class:PowerDistributionBoard+' => 'Elektrische Verteilung zur Versorgung nachgelagerter Systeme',
    'Class:PowerDistributionBoard/Attribute:board_type' => 'Verteilungstyp',
    'Class:PowerDistributionBoard/Attribute:board_type+' => 'Typ der elektrischen Verteilung.',
    'Class:PowerDistributionBoard/Attribute:board_type/Value:main_distribution' => 'Hauptverteilung',
    'Class:PowerDistributionBoard/Attribute:board_type/Value:sub_distribution' => 'Unterverteilung',
    'Class:PowerDistributionBoard/Attribute:board_type/Value:critical_load_panel' => 'Verteilung kritischer Lasten',
    'Class:PowerDistributionBoard/Attribute:board_type/Value:rack_distribution' => 'Rack-Verteilung',
    'Class:PowerDistributionBoard/Attribute:board_type/Value:other' => 'Sonstige',
    'Class:PowerDistributionBoard/Attribute:redundancy_group' => 'Redundanzgruppe',
    'Class:PowerDistributionBoard/Attribute:redundancy_group+' => 'Redundanzgruppe oder Kennzeichnung des Einspeisestrangs, z. B. A, B oder N.',
    'Class:PowerDistributionBoard/Attribute:number_of_outgoing_feeds' => 'Anzahl Abgänge',
    'Class:PowerDistributionBoard/Attribute:number_of_outgoing_feeds+' => 'Anzahl der nachgelagerten Abgänge, die von dieser Verteilung versorgt werden.',
    // Class: UPS
